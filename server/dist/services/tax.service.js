...
function calculateMonthlyNII(monthlyIncome, status) {
...
function calculateMonthlyHealthTax(monthlyIncome, status) {
...
function calculateTax(grossMonthlyIncome, taxStatus) {
